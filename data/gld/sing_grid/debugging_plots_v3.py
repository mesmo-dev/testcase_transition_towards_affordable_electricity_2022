...
if __name__ == "__main__":
    ...
    Homes = True#read homes for HVAC and water heater
...
if bid_plots is True:
    ...
    with open("flexhvacwh_setting_old/DSO_2/Substation_"+str(dso_num)+"_agent_dict.json", 'r', encoding='utf-8') as lp:
        config = json.load(lp)
    ...
    ax1[0].set_title("Retail Market Bids flexhvacwh_setting_old")
    ...
    ax1[1].set_title("DSO Bids flexhvacwh_setting_old")
    ...
    ax1[2].set_title("Bid to Load Comparison flexhvacwh_setting_old")
    
    #plt.xlim([datetime.date(2016, imonth, iday), datetime.date(2016, imonth, iday + Tday)])
    plt.savefig('flexhvacwh_setting_old_bids')
    plt.show()
